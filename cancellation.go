...
func (ls *LOBSTERCancellation) UnmarshalCsvLOBSTER(eventFields []string) (err error) {
...
func (ls *LOBSTERCancellation) MarshalCsvLOBSTER() (eventFields []string, err error) {
